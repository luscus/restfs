...
module.exports = function generateRoutes(server, callback) {
    ...
    server.post = [
        wrapProcessorHandler(server.getProcessor('prepareResponse')),
        wrapProcessorHandler(server.getProcessor('setCorsHeaders')),
        wrapProcessorHandler(server.getProcessor('formatResponseData')),
        wrapProcessorHandler(server.getProcessor('encodeResponseData')),
        wrapProcessorHandler(server.getProcessor('sendResponse'))
    ];
